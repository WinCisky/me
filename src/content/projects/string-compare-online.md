...
Two text areas, one diff result. Useful for comparing config files, log lines
or minified snippets when a full diff tool is overkill. The diff itself is a
Myers implementation small enough to stay readable, with word-level
highlighting layered on top of the line diff.
